<template>
    <div class="popup popup_center" style="z-index:99999">
        <div class="scroll">
            ...
            <div class="pophead">
                <h2>Giấy phép đi đường</h2>
                <p>Màn hình thêm mới thông tin Giấy phép đi đường</p>
            </div>
            <div class="frm">
                <form name="frmPhi" id="frmPhi" method="post" data-id="NF9fX19fMTVIMDI5ODVfX19fXzVfX19fXzE" onsubmit="return insert('xe','dk_insert','frmPhi','img_file')" enctype="multipart/form-data">
                    <input type="hidden" name="code" value="NF9fX19fMTVIMDI5ODVfX19fXzVfX19fXzE">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td width="24%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" v-model="data.registDate" class="picker hasDatepicker" autocomplete="off" placeholder="VD: 20-07-2020" maxlength="10" required="" id="dp1711425746994">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" v-model="expireDate" class="picker hasDatepicker" autocomplete="off" placeholder="VD: 30-07-2021" maxlength="10" required="" id="dp1711425746995">
                                </td>
                            </tr>
                            <tr>
                                <td>
