<template>
    <div class="popup popup_full popup_center">
        ...
        <div class="scroll" v-else>
            ...
            <form name="frmXe" id="frmXe" method="post" enctype="multipart/form-data">
                <div class="frm">
                    <table class="table">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="margin:10px 0 0 0;float:left;clear:both;width:100%">
                                        <input type="file" v-on:change="getImageUpload" id="img_file" onchange="previewImg(event,8);" multiple="multiple" accept="image/*">
                                    </p>
